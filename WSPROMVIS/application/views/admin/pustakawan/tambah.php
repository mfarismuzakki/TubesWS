...
<form class="form-horizontal" action="<?php echo site_url('CAdmin/TambahPustakawan');?>" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label class="col-lg-2 control-label">Nama</label>
        <div class="col-lg-5">
            <input type="text" name="nama_pustakawan" class="form-control">
        </div>
    </div>
